...
class Roles extends Controllers
{
    ...
    {
        $data['page_id'] = 3;
        $data['page_tag'] = " Roles - ProverMotos";
        $data['page_name'] = "Roles";
        $data['page_title'] = " Roles - <small>ProverMotos</small>";
        $this->views->getView($this, "roles", $data);
    }

    public function getRoles()
    {
        // Ciclo For para la Validación
    ...
    */
    ...
    public function setRol()
    {
        ...
        // SE EVALUA SI LA RESPUESTA ES MAYOR A 0 Y SE INSERTA EL REGISTRO
        if ($request_rol > 0) {
