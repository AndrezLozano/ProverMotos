...
class PermisosModel extends Mysql
{
    ...
    public function selectPermisosRol(int $idrol)
		{
			$this->intRolid = $idrol; // La variable intRolid asignada arriba, se le coloca el parámetro recibido
			$sql = "SELECT * FROM permisos WHERE rolid = $this->intRolid";
			$request = $this->select_all($sql); // Se llama al metodo select de la clase Padre
			return $request;
		}
